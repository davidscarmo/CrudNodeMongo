...
router.get('/', async (req, res) => 
{
    try
    {
        const projects = await Project.find().populate(['user', 'tasks']); // cria a associação entre os dados do  objeto usuário e o project
        ...
        await Promise.all(tasks.map( async task => 
            {
                ...
                project.tasks.push(projectTask); //adiciona a task no array das tasks no project
            })); 
